  ...
  const features = [
    {
      ...
      label: t("onboarding.welcome.features.auth"),
    },
    {
      icon: "chatbubble-outline",
      label: t("onboarding.welcome.features.chat"),
    },
    { icon: "card-outline", label: t("onboarding.welcome.features.payments") },
    {
      icon: "cloud-upload-outline",
      label: t("onboarding.welcome.features.uploads"),
    },
  ];
